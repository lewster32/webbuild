...
class Editor {
  constructor(renderer) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.renderer.canvas).on("mousedown", e => {
      this.handleMouseDown(e);
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.renderer.canvas).on("mouseup", e => {
      this.handleMouseUp(e);
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.renderer.canvas).on("mousemove", e => {
      this.handleMouseMove(e);
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.renderer.canvas).on("mousewheel", e => {
  ...
  findClosestObject(pos) {
    ...
    if (closestWall && closestSprite) {
      const closestWallDistance = _geom_point2__WEBPACK_IMPORTED_MODULE_1__["default"].distanceSquared(
        _geom_point2__WEBPACK_IMPORTED_MODULE_1__["default"].closestPointOnLine(
          closestWall,
      ...
      const closestSpriteDistance =
        _geom_point2__WEBPACK_IMPORTED_MODULE_1__["default"].distanceSquared(spritePos, pos) -
  ...
  findClosestWall(pos) {
    ...
    this.map.walls.forEach(wall => {
      ...
      const wallPos = _geom_point2__WEBPACK_IMPORTED_MODULE_1__["default"].closestPointOnLine(
        wall,
      ...
      const wallDistance = _geom_point2__WEBPACK_IMPORTED_MODULE_1__["default"].distanceSquared(wallPos.point, pos);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MapRenderer; });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var _data_names__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../data/names */ "./src/data/names.js");
/* harmony import */ var _objects_wall__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../objects/wall */ "./src/objects/wall.js");
/* harmony import */ var _objects_sprite__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../objects/sprite */ "./src/objects/sprite.js");
/* harmony import */ var _geom_point2__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../geom/point2 */ "./src/geom/point2.js");
...
class MapRenderer {
  constructor(canvas) {
    ...
    this.interaction = {
      panStart: new _geom_point2__WEBPACK_IMPORTED_MODULE_5__["default"](),
      panOffset: new _geom_point2__WEBPACK_IMPORTED_MODULE_5__["default"](this.width * -0.5, this.height * -0.5),
      isDown: false,
      mouseWorldPos: new _geom_point2__WEBPACK_IMPORTED_MODULE_5__["default"](),
      mouseScreenPos: new _geom_point2__WEBPACK_IMPORTED_MODULE_5__["default"](),
  ...
  changeZoom(delta, e, callback) {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].to(this, 0.15, {
      _zoom: newZoom,
      onUpdate: () => {
  ...
  worldToScreen(wx, wy) {
    return new _geom_point2__WEBPACK_IMPORTED_MODULE_5__["default"](
  ...
  drawClosestPointOnWall(
    ...
    const pc = _geom_point2__WEBPACK_IMPORTED_MODULE_5__["default"].closestPointOnLine(
      new _geom_point2__WEBPACK_IMPORTED_MODULE_5__["default"](p1x, p1y),
      new _geom_point2__WEBPACK_IMPORTED_MODULE_5__["default"](p2x, p2y),
  ...
  renderSprites(spriteClipPadding, angleIndicatorMagnitude) {
    ...
    specialSprites
      .filter(
        sprite =>
          _data_names__WEBPACK_IMPORTED_MODULE_2__["default"][sprite.picNum] === "MUSICANDSFX" && !sprite.rendererMeta.clipped
      )
      .forEach(sprite => {
        const p = this.worldToScreen(sprite.x, sprite.y);
        if (
  ...
  updateMetaData() {
    this.map.walls.forEach(wall => {
      ...
      if (wall2) {
        const wall2Pos = wall2.clone();
        wall.rendererMeta.boundingRadius = _geom_point2__WEBPACK_IMPORTED_MODULE_5__["default"].distance(
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Point2; });
class Point2 {
  constructor(x = 0, y = 0) {
    this.set(x, y);
  }
...
/* harmony import */ var _geom_point3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../geom/point3 */ "./src/geom/point3.js");


// This mainly adds the angle property to allow
// us to use it for sprite positions etc.
class Position extends _geom_point3__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
  const renderer = new _editor_maprenderer__WEBPACK_IMPORTED_MODULE_3__["default"](jquery__WEBPACK_IMPORTED_MODULE_0___default()("#mapcanvas")[0]);
  const editor = new _editor_editor__WEBPACK_IMPORTED_MODULE_2__["default"](renderer);

  jquery__WEBPACK_IMPORTED_MODULE_0___default()("canvas").hide();

  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#mapfile").on("change", e => {
    const files = e.target.files;
    if (!files.length) {
      return false;
    }
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("canvas").show();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".custom-file-label").html("<em>Loading...</em>");
    const name = files[0].name;
    const reader = new _util_mapfilereader__WEBPACK_IMPORTED_MODULE_1__["default"](files[0], map => {
      editor.setMap(map);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".custom-file-label").text(name);
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#mapfile").val(null);
  });
});
...
/***/ "./src/objects/floorceiling.js":
/*!*************************************!*\
  !*** ./src/objects/floorceiling.js ***!
  \*************************************/
/*! exports provided: Floor, Ceiling */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _geom_point2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../geom/point2 */ "./src/geom/point2.js");
...
class FloorCeiling {
  constructor() {
    ...
    this.shade = 0;
    this.palette = 0;
    this.panning = new _geom_point2__WEBPACK_IMPORTED_MODULE_0__["default"]();
  }
};

class Floor extends FloorCeiling {
  constructor() {
    super();
  }
};

class Ceiling extends FloorCeiling {
  constructor() {
    super();
  }
};
...
/* harmony import */ var _geom_position__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../geom/position */ "./src/geom/position.js");
...
class Map {
  constructor(version) {
    ...
    this.startPosition = new _geom_position__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
/* harmony import */ var _floorceiling__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./floorceiling */ "./src/objects/floorceiling.js");
...
class Sector {
  constructor() {
    this.firstWallIndex;
    this.numWalls = 0;
    this.ceiling = new _floorceiling__WEBPACK_IMPORTED_MODULE_0__["Ceiling"]();
    this.floor = new _floorceiling__WEBPACK_IMPORTED_MODULE_0__["Floor"]();
    this.visibility = 0;
    this.loTag = 0;
    this.hiTag = 0;
    this.extra = -1;
...
/*!*******************************!*\
  !*** ./src/objects/sprite.js ***!
  \*******************************/
/*! exports provided: FACE, WALL, FLOOR, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class Sprite extends _geom_position__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(x = 0, y = 0, z = 0, angle = 0) {
    ...
    this.palette = 0;
    this.clipDistance = 0;
    this.repeat = new _geom_point2__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this.offset = new _geom_point2__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this.currentSectorIndex = 0;
    this.currentStatus = 0;
    this.owner = 0;
    this.velocity = new _geom_point3__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this.loTag = 0;
    this.hiTag = 0;
    this.extra = -1;
...
class Wall extends _geom_point2__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(x = 0, y = 0) {
    super(x, y);
    this.point2;
    this.nextWall = -1;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MapFileReader; });
/* harmony import */ var _objects_map__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../objects/map */ "./src/objects/map.js");
/* harmony import */ var _objects_sector__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../objects/sector */ "./src/objects/sector.js");
...
class MapFileReader {
  ...
  parseFile(result) {
    ...
    this.map = new _objects_map__WEBPACK_IMPORTED_MODULE_0__["default"](read(view.getInt32));
    ...
    for (let i = 0; i < numSectors; i++) {
      const sector = new _objects_sector__WEBPACK_IMPORTED_MODULE_1__["default"]();
    ...
    for (let i = 0; i < numWalls; i++) {
      const wall = new _objects_wall__WEBPACK_IMPORTED_MODULE_2__["default"](read(view.getInt32), read(view.getInt32));
    ...
    for (let i = 0; i < numSprites; i++) {
      const sprite = new _objects_sprite__WEBPACK_IMPORTED_MODULE_3__["default"](
        read(view.getInt32),
        read(view.getInt32),
        read(view.getInt32)
      );
